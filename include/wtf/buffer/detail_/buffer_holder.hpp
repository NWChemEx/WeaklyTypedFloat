 ...
 *
 *  This class provides FloatBuffer with a type-erased interface for
...
public:
     ...
     *
     *  @param[in] other The other BufferHolder to compare against.
     *
...
inline void BufferHolder::assert_in_range(size_type index) const {
    if(index >= size()) {
